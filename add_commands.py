#print the entire procedure to enter a command

#print command name rules
#input command name
#check for command name validation

#print rules for calling phrases
#input command calling phrase examples
#check for validation

#print rules for keywords
#input keywords for the command
#validate the keywords

#check for priority validation:
    #check if any pair of its keywords comes into keyword set of any other command
    #check if any pair of keywords of any other command comes into its keyword set
#display any errors in priority
#display two choices:
    #1. change keyword set:
        #i. change keywords only
        #ii. change phrases and keywords
    #2. set priority

#create a new file and copy all the existing commands along with the new ones(create a new dictionary)
#use lmtool to get the tar file

#print rules for the required function(like function name, function should have no arguments)
#ask for file name
#check for file availability
#add an import line to the script file
#reprint the commands dictionary in the file after changes
#do the above for the priority too

#untar the tar file obtained from lmtool
#rename the old dic and lm files
#rename the new dic and lm files
